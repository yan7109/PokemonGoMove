...
def main():
    ...
    def run():
        ...
        for step in range(steplimit2):
            ...
            global OVERRIDE_LOC
            if(OVERRIDE_LOC):
                print('Overriding location coordinates...')
                # Need to trigger the refresh of the browser...
                global NEW_FLOAT_LAT, NEW_FLOAT_LONG
                set_location_coords(NEW_FLOAT_LAT, NEW_FLOAT_LONG, 0)
                OVERRIDE_LOC = 0
                run()
                return
